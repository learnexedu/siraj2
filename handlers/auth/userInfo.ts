...
// prisma db
import { db } from "@/app/_lib/database/db";

// prisma data
import { getUserByEmail, getUserById, getUserByPhone } from "@/app/_data/user";
import { generateVerificationToken } from "@/app/_data/verificationToken";

// schema
import { PasswordSchema, PhoneSchema, UserSchema } from "@/app/_schemas";
